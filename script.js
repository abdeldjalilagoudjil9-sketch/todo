...
function creatTodoItem(todo, todoIndex){
    ...
    todoLI.innerHTML = `
        ...
        <label class="custom-chekbox" for="${todoId}">
    ...
    const chekbox = todoLI.querySelector("input");
    chekbox.addEventListener("change", ()=>{
        allTodos[todoIndex].completed = chekbox.checked;
        saveTodos();
    })
    chekbox.checked = todo.completed;
    return todoLI;
}
